	...
	<nav class="navbar sticky-top navbar-light">
		<div class="container-fluid">
			<a class="navbar-brand" href="<%=request.getContextPath()%>" style="text-decoration: none;">
				<img src="images/SkyHighLogo.svg" alt= "" width="15%" height="15%" class="d-inline-block align-text-center" style="padding:0px;"/>
				Sky High Bank
			</a>
			<div class="d-flex">
				<% if (userID != null) { %>
				...
				<% } else { %>
				<a href="login">
					<button class="btn btn-outline-success" type="submit" value="Login" id="submitBtn" >Login</button>
				</a>
				<% } %>
			</div>
		</div>
